...
INSERT INTO `administradores` VALUES ('1','admin1','admin1'),('2','admin2','admin2');
...
INSERT INTO `almacen` VALUES (1,'Ahoy','juego',20),(2,'Art Society','juego',15),(3,'Aventureros al tren','juego',6),(4,'Avio','juego',6),(5,'Azul','juego',9),(6,'Boop','juego',7),(7,'Captain Flip','juego',4),(8,'Carcassonne','juego',6),(9,'Cascadia','juego',10),(10,'Cat in a box','juego',12),(11,'Catan','juego',15),(12,'Codenames','juego',8),(13,'Colt Express','juego',7),(14,'Cryptid','juego',9),(15,'Cubitos','juego',15),(16,'Endeavor Deep Sea','juego',5),(17,'Escape Plan','juego',4),(18,'Exploding Kittens','juego',7),(19,'Faraway','juego',8),(20,'Flamecraft','juego',7),(21,'Harmonies','juego',10),(22,'Heat','juego',13),(23,'Horrified','juego',12),(24,'insider','juego',8),(25,'Junk Art','juego',7),(26,'Keep the heroes Out','juego',9),(27,'Kelp','juego',7),(28,'Lata','juego',8),(29,'Llama Rock and Roll','juego',7),(30,'Manchas','juego',8),(31,'Mlem','juego',7),(32,'nekojima','juego',8),(33,'Pandemic','juego',8),(34,'Pelusas Revolution','juego',11),(35,'Piña Coladice','juego',7),(36,'Pistas cruzadas','juego',8),(37,'Pnzi Scheme','juego',9),(38,'Pocimas y brebajes','juego',9),(39,'Power Plants','juego',7),(40,'Project L','juego',8),(41,'Root','juego',7),(42,'Scout','juego',7),(43,'SETI','juego',10),(44,'Skyteam','juego',8),(45,'Slay the Spire','juego',8),(46,'Space Base','juego',9),(47,'That time you killed me','juego',7),(48,'Time\'s Up','juego',7),(49,'Wavelength','juego',9),(50,'Wingspan','juego',9);
...
) ENGINE=InnoDB AUTO_INCREMENT=351 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='este es el carrito donde se van a registrar los pedidos de cada usuario.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `carrito` VALUES (273,1,NULL,NULL,NULL,NULL),(347,1,'Art Society',9,NULL,108),(348,1,'Ahoy',2,NULL,20),(349,2,NULL,NULL,NULL,NULL),(350,2,'Endeavor Deep Sea',4,NULL,84);
...
CREATE TABLE `usuarios` (
  ...
  `roles` varchar(45) DEFAULT 'usuario',
...
INSERT INTO `usuarios` VALUES (6,'nombre1','apellido1','usuario1','11111','1','1',1111,'usuario'),(7,'nombre2','apellido2','usuario2','22222','2','2',2222,'usuario'),(8,'nombre3','apellido3','usuario3','33333','3','3',3333,'usuario'),(9,'nombre4','apellido4','usuairo4','44444','4','4',4444,'usuario'),(10,'nombre5','apellido5','admin1','admin1','a1','a1',11111,'admin'),(11,'nombre6','apellido6','admin2','admin2','a2','s¡a2',22222,'admin');
...
-- Dump completed on 2025-06-23  7:44:52
